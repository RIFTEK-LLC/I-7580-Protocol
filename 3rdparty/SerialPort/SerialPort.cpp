...
int I7580::SerialPort::ReadData(uint8_t *buf, uint32_t size)
{
	if (!initFlag) 
		return -1;
...
int I7580::SerialPort::SendData(uint8_t *buf, uint32_t size)
{
	if (!initFlag)
		return -1;
