...
bool I7580::CamsoParser::Add_Data_To_Send(uint8_t* data, uint32_t data_size, uint8_t logic_port, uint8_t number_of_repetitions)
{
...
bool I7580::CamsoParser::Get_Next_Output_Packet(uint8_t* packet_data, uint16_t& packet_size)
{
	packet_size = 0;
...
bool I7580::CamsoParser::Get_Data(uint8_t* data_buffer, uint32_t data_buffer_size, uint32_t& input_data_size, uint8_t logic_port, int32_t timeout)
{
...
int32_t I7580::CamsoParser::Decode_Serial_Data(uint8_t next_byte)
{
